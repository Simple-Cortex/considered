...
A Markdown code fence immediately follows the closing HTML comment above (as when this
contract is pasted into a fenced ```html block in a design doc). The fence line must never
be swept into the ROLL field.
