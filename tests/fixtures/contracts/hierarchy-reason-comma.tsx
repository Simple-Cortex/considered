...
// HIERARCHY:
//   P0 breach-count - it is the only value that changes the lead's next-minute allocation, not any other metric on the floor
...
export const fixture = 'P0 reason text contains a comma; must not split into a phantom hierarchy element';
